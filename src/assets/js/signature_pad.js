...
class SignaturePad {
    constructor(canvas, options = {}) {
        ...
        this._handleMouseDown = (event) => {
            if (event.which === 1 && this.options.allowType ? event.pointerType === this.options.allowType : !0) {
    ...
    _strokeUpdate (event) {
        ...
        const x = event.clientX / this.options.zoom
        const y = event.clientY / this.options.zoom
    ...
    _handlePointerEvents () {
        ...
        this.canvas.addEventListener('pointerup', this._handleMouseUp)
    }
    _handleMouseEvents () {
        this._mouseButtonDown = false
